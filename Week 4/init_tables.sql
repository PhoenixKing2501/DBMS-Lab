...
INSERT INTO users
VALUES
        ('DOC1','Alan Donald','doctor',111111111),
        ('DOC2','Bruce Reid','doctor',222222222),
        ('DOC3','Courtney Walsh','doctor',333333333),
        ('DOC4','Malcom Marshall','doctor',444444444),
        ('DOC5','Dennis Lillee','doctor',555555555),
        ('DOC6','Jeff Thomson','doctor',666666666),
        ('DOC7','Richard Hadlee','doctor',777777777),
        ('DOC8','Kapil Dev','doctor',888888888),
        ('DOC9','Ishant Sharma','doctor',999999999),
        ('ADM1','Pradosh Mitter','admin',800000001),
        ('ADM2','Sherlock Holmes','admin',800000002),
        ('DEO1','Alan Donald','entryop',500000001),
        ('DEO2','Alan Donald','entryop',500000002),
        ('FDO1','Alan Donald','frontop',600000001),
        ('FDO2','Alan Donald','frontop',600000002);